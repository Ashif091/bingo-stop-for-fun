...
export default function GamePage() {
  ...
  // Also show for players who clicked "Play Again" during ended phase (their grid is reset, currentPlacement === 1)
  const showArrangingScreen = (gameState.phase === 'arranging' || 
    (gameState.phase === 'ended' && myPlayer?.currentPlacement === 1));
  
  if (showArrangingScreen && myPlayer) {
    return (
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      {/* Winner Modal - show to all players in ended phase who haven't clicked Play Again */}
      {gameState.phase === 'ended' && myPlayer && myPlayer.currentPlacement !== 1 && (
        <WinnerModal
